...
class VSMEC_Output(nn.Module): 
    def __init__(self,dropout ,  d_input, output_labels):
      
        super(VSMEC_Output, self).__init__()

        self.dense = nn.Linear(d_input , output_labels ,  bias=True)
...
class LSTM_Attention(nn.Module):
    def __init__(self, vocab_size ,  input_size = 256, hidden_size= 256, num_layers=6, bidirectional=False, dropout = 0.1, no_cuda = False):
        ...
        self.outputHead = VSMEC_Output(dropout , hidden_size, 7)
...
class XLSTM(nn.Module):
    def __init__(self, vocab_size , config_path , dropout = 0.1, no_cuda = False):
        ...
        self.outputHead = VSMEC_Output(dropout , cfg.embedding_dim , 7)
